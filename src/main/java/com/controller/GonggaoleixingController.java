...
public class GonggaoleixingController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GonggaoleixingEntity gonggaoleixing, HttpServletRequest request){
        EntityWrapper<GonggaoleixingEntity> ew = new EntityWrapper<GonggaoleixingEntity>();
		PageUtils page = gonggaoleixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, gonggaoleixing), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<GonggaoleixingEntity> wrapper = new EntityWrapper<GonggaoleixingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = gonggaoleixingService.selectCount(wrapper);
