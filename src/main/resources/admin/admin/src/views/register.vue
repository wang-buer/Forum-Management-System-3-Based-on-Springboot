  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">论坛管理系统 注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="备注" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.beizhu" autocomplete="off" placeholder="备注" type="text" />
			</el-form-item>
